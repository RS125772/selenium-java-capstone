...
public class HomePageTest extends BaseTest {
        ...
        public void verifyCategoryNavigationFunctionality() {
                ...
                Assert.assertTrue(homePage.isDigitalDownloadsPageDisplayed(),
        ...
        public void verifyValidSearchFunctionality() {
                CommonUtils commonUtils = new CommonUtils(driver);
                HomePage homePage = new HomePage(driver);
                homePage.searchProduct(TestDataReader.getProperty("searchProduct"));
        ...
        public void verifyInvalidSearchFunctionality() {
                CommonUtils commonUtils = new CommonUtils(driver);
                HomePage homePage = new HomePage(driver);
                homePage.searchProduct(TestDataReader.getProperty("invalidSearchProduct"));
        ...
        public void verifyFooterOptionsDisplayedCorrectly() {
                ...
                Assert.assertTrue(actualFooterOptions.containsAll(expectedFooterOptions),
                                "Some footer options are missing");
